...
def mtrng_loss(model, x, y, l1_coef=0, predict_list=None):
    ...
    # correct_per_sample = (predict == y).sum(dim=1) / len(predict_list)
    # info = {"l1_loss": l1_loss, "batch_size": batch_size, "correct_per_cat": correct_per_cat}
    # info = {"l1_loss": l1_loss, "batch_size": batch_size, "correct_per_sample": correct_per_sample,"correct_per_cat": correct_per_cat}
