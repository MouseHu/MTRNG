...
def main():
    ...
    # dubs = [0.5049588846337056, 0.27258842974901754, 0.9743680050540504, 0.46468934896583014, 0.4958091906315887]
    # random_numbers = [0.5768720925005013, 0.5449909309706749, 0.6298181680370645, 0.6442524857464742,
    #                   0.5220131280163802, 0.35284477244389056, 0.8444002903349745, 0.7306615381720967,
    #                   0.48528684634550223, 0.2056305350619152, 0.1569716188544088, 0.5015475288639402,
    #                   0.8262732605450156, 0.8701360882893927, 0.3506496346157335, 0.8041147342285391,
    #                   0.3303266468253234, 0.863718899124913, 0.8722312854482603, 0.33093730683036116]
    # dubs = random_numbers[:5]
    # print("Input:", dubs)
    # prediction = crack(dubs, 15)
    # print("GroundTruth:", random_numbers[5:])
