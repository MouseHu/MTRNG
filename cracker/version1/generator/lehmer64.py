...
def main():
    ...
    if args.type == 'lehmer64':
        print(lehmer64(seed=args.seed, datasize=args.generate_len))
    elif args.type == 'mt19937':
        print(mt19937(seed=args.seed, datasize=args.generate_len))
    elif args.type == 'lcg':
        print(lcg(seed=args.seed, m=args.m, c=args.c, n=args.n, datasize=args.generate_len))
