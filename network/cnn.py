...
class ResBlock(nn.Module):
    def __init__(self, in_channels, middle_channels, out_channels, kernel_size=33, add_activation=True, pad=None):
        ...
        if out_channels != in_channels:
            ...
            self.down_sample = nn.Sequential(
                nn.Conv1d(in_channels, out_channels, downsample_kernel_size),
